...
class Text_Expert:
    ...
    def get_system_prompt(self):
        ...
        {context_01}
        ### END OF First set of Document 
        
        Then compare against the candidates' CV
        
        ### Second Set of Document
        {context_02}
        ### END OF Second Set of Document
...
def jd_upload():
    ...
    pdf_file_01 = st.file_uploader("###### Upload 1st set PDF docs", type=["pdf"], accept_multiple_files=True)

    # if a pdf file is uploaded
    if pdf_file_01:
        st.session_state.context_01 = retrieve_multi_pdf_text(pdf_file_01)
        # retrieve the text from the pdf
        # if len(pdf_file_01)>1:
        #     st.session_state.context_01 = retrieve_multi_pdf_text(pdf_file_01)
        # else:
...
def cv_upload():
    # create a upload file widget for a pdf
    pdf_file_02 = st.file_uploader("###### Upload 2nd set PDF docs", type=["pdf"], accept_multiple_files=True)

   # if a pdf file is uploaded
    if pdf_file_02:
        st.session_state.context_02 = retrieve_multi_pdf_text(pdf_file_02)
        # retrieve the text from the pdf
        # if len(pdf_file_02)>1:
        #     st.session_state.context_02 = retrieve_multi_pdf_text(pdf_file_02)
        # else:
        #     st.session_state.context_02 = retrieve_pdf_text(pdf_file_02)
